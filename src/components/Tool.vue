  ...
  <div id="tool">
    ...
    >
      <el-form ref="form" :model="form" label-width="80px" size="mini">
        ...
        <el-form-item label="抽取方式">
          <el-select v-model="form.mode" placeholder="请選取本次抽取方式">
    ...
    >
      <el-input
        type="textarea"
        :rows="10"
        placeholder="请输入對應的號碼和名單(可直接從excel複製)，格式(號碼 名字)，導入的名單將代替號碼顯示在抽獎中。如：
1 張三
2 李四
3 王五
				"
